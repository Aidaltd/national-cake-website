...
function StepperIndicator({
  ...
  return (
    <span
      ...
      className={cn(
        "bg-muted text-muted-foreground data-[state=active]:bg-custom-primary data-[state=completed]:bg-custom-primary data-[state=active]:text-primary-foreground data-[state=completed]:text-primary-foreground relative flex size-6 shrink-0 items-center justify-center rounded-full text-xs font-medium",
        className
      )}
      data-state={state}
      {...props}
