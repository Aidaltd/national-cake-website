...
export default function Hero() {
  ...
  return (
    <section className="relative isolate overflow-hidden text-white">
      ...
      {/* Content wrapper */}
      <div className="relative mx-auto flex flex-col items-start justify-end gap-8 px-4 py-16 md:py-24 md:pb-20 md:px-10">
        <h1 className="max-w-4xl lg:text-7xl lg:leading-tighter section-title text-white">
          ...
          <br className="hidden sm:block" /><span className=" inline-flex md:hidden"> &nbsp;</span> One Box at a Time
        </h1>
        ...
        <p className="text-green-500 bg-white p-2 px-4 font-medium text-base">
        ...
        {/* Stats */}
        <div className="mt-14 grid w-full gap-y-10 gap-x-8 grid-cols-2 lg:grid-cols-4">
